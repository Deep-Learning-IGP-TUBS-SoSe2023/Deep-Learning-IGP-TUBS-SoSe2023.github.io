...
## YOLOv5 vs YOLOv8:The Battle for Object Detection Supremacy
...
This paper provides an overview and introduction of two main models used for object detection applications, showing outstanding results in performance and accuracy.
...
The dataset used in our experiments is [NWPU VHR-10 Dataset](https://drive.google.com/drive/folders/13Vj27NP2TY2aJ5AlI4LGAnVd8ghEizrZ?usp=drive_link). The **NWPU VHR-10 dataset**, introduced by Cheng and Han in 2016, comprises **10 distinct categories** as observed in *Figure 1*, comprising airplane, baseball diamond, basketball court, bridge, harbor, ground track field, ship, storage tank, tennis court, and vehicle. and is enriched
with 650 meticulously annotated images.

<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/classes.png" alt="Image" width="570" height="240">
  <br>
...
Notably, the NWPU VHR-10 dataset comprises 3,896 meticulously annotated object instances, featuring horizontal bounding boxes encompassing a diverse array of objects as presented in Figure 5, including 757 airplanes, 655 storage tanks, 598 vehicles, 524 tennis courts, 390 baseball diamonds, 302 ships, 224 harbors, 163 ground track fields, 159 basketball courts and 124 bridges. 

The dataset’s structure comprises three distinct folders. Firstly, the **"negative image set"** houses *150 images* that lack any instances of the specified object classes. Conversely, the **"positive image set"** encompasses *650 images*, each featuring at least one target object for detection. Finally, the **"ground truth"** folder comprises *650 individual text files*, with each file uniquely corresponding to an image contained within the "positive image set" folder. This organizational framework facilitates precise labeling and association between target objects and their respective images.

As the "negative image set" exclusively comprises background images, its primary purpose is to enhance the generalization capacity of our model. This augmentation equips the model to effectively detect novel instances of objects, thus expanding its ability to discern objects in diverse contexts and scenarios.
...
<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/yolov5arch1.jpg" alt="Image" width="800" height="800">
  <br>
...
<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/yolov8arch.jpg" alt="Image" width="800" height="800">
  <br>
...
<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/yolov5metrics.png" alt="Image" width="570" height="240">
  <br>
  <em>Figure 4. YOLOv5 metrics and losses</em>
</p>

<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/yolov8metrics.png" alt="Image" width="570" height="240">
  <br>
...
<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/QR.png" alt="Image" width="570" height="245">
  <br>
</p>
...
<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/018.jpg" alt="Image" width="533" height="637">
  <br>
...
<p align="center">
  <img src="https://github.com/Deep-Learning-IGP-TUBS-SoSe2023/Group_B/blob/master/Images/Final/dota.jpg" alt="Image" width="518" height="500">
  <br>
